...
window.$_||function(h,c){var b=function(a){b.ready(a)};b.full_location="";b.rela_location="";b.safe=function(a){if(typeof a=="undefined")return"";for(var f=[/&/g,/\"/g,/\'/g,/</g,/>/g],t=["&amp;","&quot;","&#039;","&lt;","&gt;"],a=String(a),d=0,c=f.length;d<c;d++)a=a.replace(f[d],t[d]);return a};b.unsafe=function(a){if(typeof a=="undefined")return"";for(var f=[/&amp;/g,/&quot;/g,/&#039;/g,/&lt;/g,/&gt;/g],c=["&",'"',"'","<",">"],a=String(a),d=0,b=f.length;d<b;d++)a=a.replace(f[d],c[d]);return a};
...
(c.addEventListener("DOMContentLoaded",m,false),h.addEventListener("load",function(){i=true;j()},false));h.$_=b}(window,window.document);
